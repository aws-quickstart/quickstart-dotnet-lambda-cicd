...
:quickstart-project-name: quickstart-dotnet-lambda-cicd
:partner-product-name: .NET CI/CD pipeline for Serverless Applications
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: .NET CI/CD pipeline for Serverless Applications
...
:aws-contributors: Andy Hopper, AWS Microsoft Specialst SA Team
